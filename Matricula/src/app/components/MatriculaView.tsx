import { ChevronRight, Search, Eye, Star, CheckCircle, AlertCircle } from 'lucide-react';
    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span className="font-medium text-gray-900">Validación de Diplomas</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">
          OFICINA DE MATRÍCULA - VALIDACIÓN DE DIPLOMAS
        </h1>
      </div>
      ...
      <Card>
        <div className="p-6 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            {/* Pendientes Badge */}
            <div className="flex items-center gap-2 px-4 py-2 rounded-lg" style={{ backgroundColor: '#78276B20' }}>
              <AlertCircle className="w-5 h-5" style={{ color: '#78276B' }} />
              <span className="text-sm font-semibold" style={{ color: '#78276B' }}>
